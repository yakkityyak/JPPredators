...
//  JP Apex Predators
//
//  Created by Jakob Hjortshøj on 29/08/2022.
//
        ...
        ScrollView {
            VStack(alignment: .trailing) {
                ...
                VStack(alignment: .leading) {
                    ...
                    Text("Appears In")
                        .font(.title3)
                    //Uses the string movie as the id
